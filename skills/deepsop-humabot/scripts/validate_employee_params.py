...
覆盖 AiWa / Frank / Fran / Lisa / Toby 的所有结构强约束与固定值规则。
...
注意：
- 本脚本只覆盖 LLM 高频犯错点（key 大小写、必填漏字段、固定值、类型、Step1 内部变量泄漏、Toby methodType=3 默认依赖）。
...
VALID_EMPLOYEES = {"AiWa", "Frank", "Fran", "Lisa", "Toby"}
