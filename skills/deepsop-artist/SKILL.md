...
description: |
  ...
  需要 API Key 授权：已有账号请前往 https://ai.deepsop.com/login?isClaw=2 登录获取；没有账号请前往 https://ai.deepsop.com/register?isClaw=2 注册后获取。
...
1. 访问入口：
   - **已有账号** → [https://ai.deepsop.com/login?isClaw=2](https://ai.deepsop.com/login?isClaw=2) 登录获取
   - **没有账号** → [https://ai.deepsop.com/register?isClaw=2](https://ai.deepsop.com/register?isClaw=2) 注册获取
2. 登录后在复制您的 API Key
